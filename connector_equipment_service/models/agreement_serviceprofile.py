...
class AgreementServiceProfile(models.Model):
    ...
    def write(self, vals):
        ...
        if vals.get('stage_id', False) == 11 and self.equipment_id.managed:
        ...
        if vals.get('stage_id', False) == 12 and self.equipment_id.managed:
        ...
        if vals.get('equipment_id', False) and self.equipment_id:
            ...
            if self.equipment_id.managed:
                ...
                if ((self.stage_id.id == 11 and
                        not vals.get('stage_id', False))
                        or vals.get('stage_id', False) == 11):
                    self.equipment_id._connect('suspend_service',
                                               serviceprofiles=self)
