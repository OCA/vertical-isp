...
class contract_service(models.Model):
    ...
    def create_analytic_line(self, mode='manual', date=None):
        ...
        for line in self:
            ...
            if line.account_id and line.account_id.partner_id:
                ...
                if line.analytic_line_type == 'r':
                    if mode == 'prorata':
                        ...
                        month_days =\
                        calendar.monthrange(activation_date.year,
                                            activation_date.month)[1]
                        used_days = month_days - activation_date.day
                        ptx = (100 * used_days / month_days)
                        ...
                        next_month = datetime.date(
                            next_month.year,
                            next_month.month)
                        interval = date_interval(next_month, False,
                                                 date_format)
                    elif mode == 'manual':
                        amount = line.product_id.list_price
                    ...
                    interval = ''
                    amount = line.product_id.list_price
                general_account_id = line.product_id.\
                    property_account_expense.id or line.product_id.categ_id.\
